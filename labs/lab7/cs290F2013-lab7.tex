...
In the MAJOR's main directory you should see the scripts {\tt ant}, {\tt javac}, and {\tt mmlc}.  In order to continue
...
%     [junit] MAJOR: ------------------------------------------------------------
%     [junit] MAJOR: 1/1 - triangle.test.TestSuite$null (5ms / 79):
%     [junit] MAJOR: 650 (70 / 79 / 79) -> AVG-RTPM: 8ms
